...
int main()
{
  ...
  h.onMessage([&fusionEKF,&tools,&estimations,&ground_truth,&output](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length, uWS::OpCode opCode) {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
    	  ...
    	  if (sensor_type.compare("L") == 0){
    		  ...
    		  output <<meas_package.raw_measurements_[0] <<"\t"
